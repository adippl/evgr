...
PATCHES=(
	...
	"${FILESDIR}/ceph-18.2.4-ceph-volume-fix-set_dmcrypt_no_workqueue-1.patch"
	"${FILESDIR}/ceph-18.2.4-ceph-volume-fix-set_dmcrypt_no_workqueue-2.patch"
	"${FILESDIR}/ceph_placement_id.patch"
)
