...
if [[ ${PVR} != "999" ]] ; then
	...
	EGIT_BRANCH="slingamn-udns.10"
fi

EGIT_REPO_URI="https://github.com/rakshasa/libtorrent"
...
PATCHES=(
	"${FILESDIR}"/libtorrent-0.13.8-sysroot.patch
	"${FILESDIR}"/libtorrent-0.13.8-configure-clang-16.patch
)
